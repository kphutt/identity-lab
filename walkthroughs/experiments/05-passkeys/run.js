  ...
  await explore('Pick a scenario to explore:', [
    ...
    },
    {
      ...
      fn: async () => {
        ...
        console.log(`       physical proximity. BLE is ONLY for the initial`);
        console.log(`       handshake — it verifies the phone is nearby.`);
        console.log();
        ...
        console.log();
        console.log(`  5. Response tunneled back via cloud relay`);
        console.log(`     ↳ Signed assertion travels phone → cloud relay → laptop`);
        console.log(`       → browser → RP. After the BLE proximity check, data`);
        console.log(`       flows through a cloud relay (caBLE protocol), NOT over`);
        console.log(`       BLE. The RP sees a normal WebAuthn response — it doesn't`);
        console.log(`       know or care that the authenticator was a phone.`);
        console.log();
